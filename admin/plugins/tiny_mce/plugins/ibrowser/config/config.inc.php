...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		...
		array (																		
			'value'   	=> "/dale/dale/uploads/tinymce/",												
			'text'    	=> 'Site Pictures',
		),
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('/zoned_out/images/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	$cfg['base_url'] 	= "http://localhost:9999"; 							// base url; e.g. 'http://localhost/'	
