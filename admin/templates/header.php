	<div id="header" style="background-color:#b51e27;color:#FFFEEF;">
    	<div id="logged-user">
  		...
  		<div id="logo-area" style="color:white;margin-top:5px;font-weight:bold;">
			hauthunger.ch<br/>Content Management System
		</div>    	
    </div>
    <div id="navigation">    	
        <ul class="sf-menu" style="background:#b51e27;">
			
			<li<?php if ($_REQUEST['option'] == "events" or $_REQUEST['option'] == "events-m"){echo ' class="active"';}?>><a href="<?php echo INDEX_PAGE?>events">Calendar Management</a></li>
