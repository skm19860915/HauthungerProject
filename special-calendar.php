<body style="background-color:#646161;margin-top:10px;">
<script src='jquery-1.9.1.min.js'></script>
	<script src='jquery-ui-1.10.2.custom.min.js'></script>
		...
		<style type='text/css'>
			...
			.fc-event {
				border:0px solid #646161 !important;
				padding:0px !important;
			}
			
			.event1{background-color:#FFFFFF;color:#969696;font-color:#969696;border:1px solid #B7B7B7 !important;}
			.event2{background-color:#FFCC00;color:white;font-color:white;border:1px solid #E8B900 !important;}
			.event3{background-color:#00CCFF;color:white;font-color:white;border:1px solid #02B1DD !important;}
			.event4{background-color:#CCFF66;color:white;font-color:white;border:1px solid #BBF742 !important;}
			.event5{background-color:#CC66FF;color:white;font-color:white;border:1px solid #C350FC !important;}
			.event6{background-color:#FF99FF;color:white;font-color:white;border:1px solid #F96BF9 !important;}
			...
			.qtip-contentWrapper{border:0px !important;padding:0px !important;margin:0px !important;}
		</style>
		<script>
		$(document).ready(function() {			
			$('#calendar').fullCalendar({
				...
				eventRender: function(event, element) {
					if (event['dayname'] == "Saturday" || event['dayname'] == "Friday"){
						element.qtip({
	...
	function emailevent(email,eventid) {
		...
		<!--<div id='loading' style="clear:both;font-family:Arial,Helvetica,Geneva,Swiss,SunSans-Regular;font-size:20px;size:20px;font-weight:bold;color:white;font-color:white;display:none;margin-left:400px;">Loading...</div>-->
		<div id='calendar' style="width:910px;margin-top:20px;font-family:Arial,Helvetica,Geneva,Swiss,SunSans-Regular;margin-bottom:40px;"></div>
 </body>    
